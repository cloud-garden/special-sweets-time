 ...
 * @author Takenouchi
 */
public class NewgoodsWeekdayTime {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
		...
		job.setJarByClass(NewgoodsWeekdayTime.class);       // ★このファイルのメインクラスの名前
		...
		String outputpath = "out/takenouchi/newGoods/weekdayTime";     // ★MRの出力先
		if (args.length > 0) {
			inputpath = args[0];
		}
